...
declare global {
    ...
    export namespace IEditor {
        ...
        export interface IWebview {
            ...
            /**
             * Attach the webview to a placeholder widget. The webview will be visible when attached.
             */
        ...
        export interface ITypeRegistry {
             ...
             */
            getNodeMenuItems(type: WorldType): Record<string, TypeMenuItems>;
             ...
             */
            getComponentMenuItems(type: WorldType, inHierarchyMenu?: boolean): Record<string, TypeMenuItems>;
        ...
        export interface IMenuItem {
            ...
            /**
             * Sets the position of the menu item. Supported syntax: "first" / "last" / "before ids" / "after ids" / "beforeGroup ids" / "afterGroup ids".
             * "next" indicates the position immediately following the previously defined menu item.
        ...
        export interface IAssetDb {
             ...
             * @param allowOverwrite Whether to allow overwriting the file. If the file already exists, the file is overwritten. 
